					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order manager",
									"targetURL": "#ordermanager-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"ordermanager-display": {
								"semanticObject": "ordermanager",
								"action": "display",
								"description": "Admin dashboard orders manager.",
								"title": "Order manager",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordermanager",
									"url": sap.ui.require.toUrl("ordermanager")
								}
							}
						}
					}
